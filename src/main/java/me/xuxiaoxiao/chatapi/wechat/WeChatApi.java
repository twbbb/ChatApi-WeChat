...
final class WeChatApi {
    ...
    static {
        XTools.cfgDef(CFG_WORKDIR, CFG_WORKDIR_DEFAULT);
    }
    ...
    String sid;
    String dataTicket;
    File folder = new File(XTools.cfgGet(CFG_WORKDIR));
    ...
    String jslogin() {
        ...
        String rspStr = XTools.http(request).string();
    ...
    RspLogin login() {
        ...
        RspLogin rspLogin = new RspLogin(XTools.http(request).string("utf-8"));
    ...
    RspInit webwxinit() {
        ...
        RspInit rspInit = GSON.fromJson(XTools.http(request).string("utf-8"), RspInit.class);
    ...
    RspStatusNotify webwxstatusnotify(String userName, int notifyCode) {
        ...
        return GSON.fromJson(XTools.http(request).string("utf-8"), RspStatusNotify.class);
    }
    ...
    RspGetContact webwxgetcontact() {
        ...
        request.query("pass_ticket", this.passticket);
        return GSON.fromJson(XTools.http(request).string("utf-8"), RspGetContact.class);
    }
    ...
    RspBatchGetContact webwxbatchgetcontact(List<Contact> contactList) {
        ...
        return GSON.fromJson(XTools.http(request).string("utf-8"), RspBatchGetContact.class);
    }
    ...
    RspSyncCheck synccheck() {
        ...
        request.query("r", System.currentTimeMillis());
        request.query("_", time++);
        return new RspSyncCheck(XTools.http(request).string("utf-8"));
    }
    ...
    RspSync webwxsync() {
        ...
        RspSync rspSync = GSON.fromJson(XTools.http(request).string("utf-8"), RspSync.class);
    ...
    RspSendMsg webwxsendmsg(ReqSendMsg.Msg msg) {
        ...
        return GSON.fromJson(XTools.http(request).string("utf-8"), RspSendMsg.class);
    }
    ...
    RspRevokeMsg webwxrevokemsg(long clientMsgId, long serverMsgId, String userName) {
        ...
        return GSON.fromJson(XTools.http(request).string("utf-8"), RspRevokeMsg.class);
    }
    ...
    File webwxgetmsgimg(long msgId, String type) {
        ...
        File imgFile = XTools.http(request).file(folder.getAbsolutePath() + File.separator + String.format("image-%s-%s", String.valueOf(type), msgId));
        try {
    ...
    File webwxgetvoice(long msgId) {
        ...
        request.query("skey", skey);
        request.query("pass_ticket", passticket);
        return XTools.http(request).file(folder.getAbsolutePath() + File.separator + String.format("voice-%s.mp3", msgId));
    }
    ...
    File webwxgetvideo(long msgId) {
        ...
        return XTools.http(request).file(folder.getAbsolutePath() + File.separator + String.format("video-%d.mp4", msgId));
    }
    ...
    File webwxgetmedia(long msgId, String filename, String mediaId, String sender) {
        ...
        return XTools.http(request).file(folder.getAbsolutePath() + File.separator + String.format("media-%d%s", msgId, suffix));
    }
    ...
    RspVerifyUser webwxverifyuser(int opCode, String userName, String verifyTicket, String verifyContent) {
        ...
        return GSON.fromJson(XTools.http(request).string("utf-8"), RspVerifyUser.class);
    }
    ...
    RspOplog webwxoplog(int cmdId, int op, String userName, String remarkName) {
        ...
        return GSON.fromJson(XTools.http(request).string("utf-8"), RspOplog.class);
    }
    ...
    RspUpdateChatroom webwxupdatechartroom(String chatroom, String fun, String name, List<String> memberList) {
        ...
        return GSON.fromJson(XTools.http(request).string("utf-8"), RspUpdateChatroom.class);
    }
    ...
    RspCheckUpload webwxcheckupload(File file, String fromUserName, String toUserName) {
        ...
        return GSON.fromJson(XTools.http(request).string("utf-8"), RspCheckUpload.class);
    }
    ...
    RspUploadMedia webwxuploadmedia(String fromUserName, String toUserName, File file, String aesKey, String signature) throws IOException {
        ...
        if (file.length() < 1024L * 1024L) {
            ...
            return GSON.fromJson(XTools.http(request).string("utf-8"), RspUploadMedia.class);
        } else {
            ...
            try (BufferedInputStream bfinStream = new BufferedInputStream(new FileInputStream(file))) {
                for (long sliceIndex = 0, sliceCount = (long) Math.ceil(file.length() / 512D / 1024D); sliceIndex < sliceCount; sliceIndex++) {
                    ...
                    rspUploadMedia = GSON.fromJson(XTools.http(request).string("utf-8"), RspUploadMedia.class);
                }
            }
